...
const SliderForm = ({ fileList, form, onFinish, setFileList, onReset, edit = false, loading = false }: SliderFormProps) => {
            ...
            <div className="grid">
                <Card style={{ marginBottom: 16, border: 'none' }} className="col-6">
                    <>
                        ...
                        <Form.Item label="Tên slider" name="slideName" rules={[{ required: true, message: "Vui lòng nhập thông tin" }]}>
                            <Input placeholder="Nhập vào" />
                        </Form.Item>
                        <Form.Item label="Đường dẫn" name="URL" rules={[{ required: true, message: "Vui lòng nhập thông tin" }]}>
                            <Input placeholder="Nhập vào" />
                        </Form.Item>
                        <Form.Item label="Trạng Thái" name="status">
                            <Select placeholder="Lựa chọn" allowClear showSearch optionFilterProp="children">
                                <Select.Option value='hidden'>Ẩn slider</Select.Option>
                                <Select.Option value='active'>Hiển thị slider</Select.Option>
                            </Select>
                        </Form.Item>
                    </>
                </Card>
