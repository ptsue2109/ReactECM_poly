    ...
    return (
        <Form layout="vertical" form={form} onFinish={onFinish}>
            <Card style={{ marginBottom: 16 }}>
                {!loading && (
                    <>
                        <Form.Item label="Tên người đặt hàng" name="username" rules={[{ required: true, message: "Vui lòng nhập thông tin" }]}>
                                ...
                                <>
                                    ...
                                    {fields.map((field) => (
                                        <Input.Group compact key={field.key}>
                                            ...
                                            <Form.Item name={[field.name, "price"]} style={{ marginBottom: 0, marginTop: 16, width: "15%" }}>
                        ...
                        <Form.Item label="Tổng tiền" name="totalPrice" style={{ marginTop: 16 }}>
                            <Input disabled={true} />
                        </Form.Item>
