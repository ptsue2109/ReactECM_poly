            ...
            <div className="grid">
                <Card style={{ marginBottom: 16, border: 'none' }} className="col-6">
                    <>
                        ...
                        <Form.Item label="Tên thương hiệu" name="brandName" rules={[{ required: true, message: "Vui lòng nhập thông tin" }]}>
                            <Input placeholder="Nhập vào" />
                        </Form.Item>
                        <Form.Item label="Trạng Thái" name="status">
                            <Select placeholder="Lựa chọn" allowClear showSearch optionFilterProp="children">
                                <Select.Option value='hidden'>Ẩn thương hiệu</Select.Option>
                                <Select.Option value='active'>Hiển thị thương hiệu</Select.Option>
                            </Select>
                        </Form.Item>
                    </>
                </Card>
